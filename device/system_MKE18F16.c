...
void SystemInit (void) {
  ...
  /* Do NOT re-enable code cache until stability is confirmed.
   * Stale-cache HardFaults were observed after J-Link reflash
   * without full POR (e.g. fault inside CLOCK_InitSysPll). */
